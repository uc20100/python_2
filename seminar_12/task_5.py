...
class Rectangle:
    ...
    __repr__(): возвращает строковое представление прямоугольника, которое может быть использовано для создания нового объекта.
     ...
     Декораторы свойств:
    @property
    length(self): возвращает длину прямоугольника,
    @property
    width(self): возвращает ширину прямоугольника,
    @length.setter
    length(self, value): задает длину прямоугольника,
    @width.setter
    width(self, value): задает ширину прямоугольника.
    """
    # Экономим память
...
if __name__ == '__main__':
    rect1 = Rectangle(4000000, 500000)
    rect2 = Rectangle(3, 3)
    # rect2.length = 9
    ...
    print(f'Размер объекта в памяти: {sys.getsizeof(rect1)} байт')
    print(rect1.__dict__)
